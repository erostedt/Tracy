...
inline RGBA32 ToByteColor(glm::vec4 float_color)
{
    RGBA32 rgba32;
...
class Renderer
{
  ...
  private:
    Ray GenerateRayAt(const ProjectionCamera &camera, uint32_t pixel_x, uint32_t pixel_y)
    {
